...
class TripTasks:
    ...
    def gather_task(self, agent, origin, interests, range):
        return Task(
            description=dedent(f"""
                ...
                This guide should provide a thorough overview of what the city has to offer, including hidden gems, cultural hot spots, 
    ...
    def plan_task(self, agent, origin, interests, range):
        return Task(
            description=dedent(f"""
                Expand this guide into a full 7-day travel itinerary with detailed per-day plans, including 
            ...
            expected_output=dedent(f"""
                ...
                anticipated weather conditions, recommended clothing and items to pack, and a detailed budget, ensuring THE BEST TRIP EVER in Japanese.
                Be specific and give it a reason why you picked # up each place, what make them special!
            """
            ),
            agent=agent,
        )
